...
### 📌 待看（稍后阅读）
- 遇到想看的先「加入待看」丢进口袋，不打断当前节奏
- 无聊 / 没方向时，点一下「待看」分类慢慢翻
- 看完一键移出，收藏本身保留

### 📊 浏览统计（时间追踪式）
- 后台自动记录每个网站的停留时长（计划中，见 Roadmap）
- 日历热力图 + 域名排行 + 时段分析（计划中）
...
src/
  ...
  utils/
    ...
    bookmarks.ts                  # 收藏 CRUD / 搜索 / 备份 / 一键整理 / 待看
